...
Neptune = __webpack_require__(19);
...
Metacompiler = __webpack_require__(2);
        ...
        return FsPromise.readFile(sourceFile).then(function(source) {
          ...
          return Promise.all(array(result.output.compiled, function(text, extension) {
            ...
            if (prettier && extension === "js") {
              try {
                text = __webpack_require__(20).format(text);
              } catch (error) {
                e = error;
                log(e.message);
...
module.exports = [
  __webpack_require__(2), __webpack_require__(9), __webpack_require__(10), {
...
module.exports = __webpack_require__(1).includeInNamespace(__webpack_require__(13)).addModules({
  CaffeineMcParser: __webpack_require__(7),
